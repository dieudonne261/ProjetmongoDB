    ...
    <div class="form2" >
      <div class="form1">
        <div class="login-form" >
          <h2 class="text-light mb-3">S'inscrire</h2>
      ...
      <div class="form1">
        <div class="login-form" >
          ...
          <div class="form-floating mb-3 mt-2">
            <input type="text" name="telephone" class="form-control rounded-3 border-light" id="floatingPhone" placeholder="" required>
          ...
          <div class="form-floating mb-4">
            <input type="date" class="form-control rounded-3 border-light" name="datedenai" id="datedenai" required>
            <label for="datedenai">Date de naissance</label>
          </div>
          <a href="../index.php" class="btn btn-link mt-1 text-light">J'ai deja un compte...</a>
        </div>
      </div>
    </div>
  </form>
